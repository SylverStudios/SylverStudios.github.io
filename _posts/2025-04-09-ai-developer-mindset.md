...
3. **Know When Not to Use AI**
   - Simple tasks that you already know it's done as fast as you can type
   - Minor changes very specific to your code base
   - When the change depends on specific data (bug with specific user in your logs)
...
If that example seems long, you're right. This makes a difference and it's why I script the bulk of that context AND why there comes a point where you will absolutely have diminishing returns because thorough input is so valuable, the result needs to also be really high value to be worth it.
